...
const PROTECTED_POLICY_DOMAINS = [
  ...
  'ACTIVE_AUTHORITY_TIER', // PASSO 14B, item 2/4 — em qual tier (TIER_0..TIER_4) o sistema opera é protegido; promoção exige AUTHORITY_PROMOTION_GATE, nunca decisão direta da LLM.
];
